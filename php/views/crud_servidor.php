...
<!-- Modal para registrar/editar Servidor -->
<div id="modalActivo" class="modal" style="display:none;">
    <div class="modal-content">
        <span class="close">&times;</span>
        <h3 id="modal-title">Registrar Servidor</h3>
        
        <form id="formActivo" method="POST" action="../controllers/procesar_servidor.php">
...
<!-- CSS específico para Servidores -->
<style>
    ...
    #tablaServidores th:nth-child(11),
    #tablaServidores td:nth-child(11) {
        width: 120px;
        text-align: center;
    }
</style>
